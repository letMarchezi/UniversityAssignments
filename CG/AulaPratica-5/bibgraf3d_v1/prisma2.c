...
//	1) identifique a posição dos observadores para este exemplo.

//	2) identifique as ambiguidades do modelo de arame.
...
int main(void) {
 ...
 viewup = SetVertex3d(1.0, 0.0, 0.0, 1.0, 0);
 ...
 ob3d_2 = PerspProjFaces(cob3d_1,zpp,zcp);
 ...
 ob3d_2 = PerspProjFaces(cob3d_1,zpp,zcp);
 ob2d = Obj3dtoObj2d(ob3d_2);  
 janela2 = CreateWindow(-30,-30,30,30);
 ...
 normal = SetVertex3d(0.0, 0.0, -1.0, 1.0, 0);
 viewup = SetVertex3d(0.0, 1.0, 0.0, 1.0, 0);
 deslocamento = SetVertex3d(15.0, 5.0, 0.0, 1.0, 0);
 m = CreateObserver(normal,viewup,deslocamento); // cria o observador
 cob3d_1 = ConvertObjectBase(m,ob3d_1);
 ob3d_2 = PerspProjFaces(cob3d_1,zpp,zcp);
 ob2d = Obj3dtoObj2d(ob3d_2); 
 janela3 = CreateWindow(-30,-30,30,30);
 porta3 = CreateViewPort(1, 301, 400, 600);
 DrawObject(ob2d,janela3,porta3,dispositivo,3);

 // quarto observador
 normal = SetVertex3d(1.0, 1.0, 1.0, 1.0, 0);
 viewup = SetVertex3d(1.0, -1.0, -1.0, 1.0, 0);
 deslocamento = SetVertex3d(0.0, 0.0, 0.0, 1.0, 0);
 m = CreateObserver(normal,viewup,deslocamento); // cria o observador
 cob3d_1 = ConvertObjectBase(m,ob3d_1); 
 ob3d_2 = PerspProjFaces(cob3d_1,zpp,zcp);
 ob2d = Obj3dtoObj2d(ob3d_2); 
 janela4 = CreateWindow(-30,-30,30,30);
