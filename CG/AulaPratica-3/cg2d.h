...
object2d * poligono_regular(float, int);
...
point2d * Centroide(object2d *);  // calcula o centro geométrico de um objeto (primeiro polígono)
float Centro_x(point2d *);
float Centro_y(point2d *);
...
point2d * LinearTransf(matrix *, point2d *);
